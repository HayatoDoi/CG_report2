...
//ADD 犬の向き
bool dog_direction = TRUE;

//ADD テクスチャ
PlaidTex plaidTex_greeen;
...
void myDisplay(void)
{
	...
	*/
	...
	glPushMatrix();
	{
		glTranslatef(0.0, -3.0, 0.0);//犬が大きくなった分、地面を下げる。
		glRotatef(-90.0f, 1.0f, 0.0f, 0.0f);
		glColor4f(1.0, 1.0, 1.0, 1.0);
		plaidTex_greeen.displayTexPolygon();
	}
	glPopMatrix();
	////////////////////////////////////////////////////////////////////////////////
	...
	//ADD&EDIT 走れと言った走る。
	if (moveFlag & dog_run) {
		//ADD 犬向きフラグによって移動する向きを変える。
		/////////////////////////////////////////////////////////////////
		if (dog_direction) {
			glTranslated(0.0, 0.0, 0.06*(walkCounter++));
		}
		else {
			glTranslated(0.0, 0.0, 0.06*(walkCounter--));
		}
	...
	glPushMatrix();
	{
		glTranslatef(0.0, -3.0, 0.0);//犬が大きくなった分、影を下げる。
		glRotatef(-90.0f, 1.0f, 0.0f, 0.0f);
		glColor3f(0.0f, 0.0f, 0.0f);
		//ADD 犬の向きによって影の座標を変える
		Oval2DFill(80.0f, 0, 3 * (dog_direction ? 1:-1), 2.5f, 5.0f);
	}
	glPopMatrix();
	//////////////////////////////////////////////////
